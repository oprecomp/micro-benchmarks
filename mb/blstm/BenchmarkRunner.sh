...
run()
{
	...
	pushd tmp
	ln -s ../data data
	echo "RUNNING: $BENCHMARK_PROG $OUTPREFIX $BMDIR/build/data/prepared/mb/blstm/fraktur_dataset/samples/ $BMDIR/build/data/prepared/mb/blstm/gt/ $BMDIR"
	echo "Output will be written to: $OUTPREFIX"
	$BENCHMARK_PROG $OUTPREFIX $BMDIR/build/data/prepared/mb/blstm/fraktur_dataset/samples/ $BMDIR/build/data/prepared/mb/blstm/gt/ $BMDIR
	popd
